...
/**
 * If AWS credentials are configured in the environment, use them. Normally
 * when we connect to DynamoDB from a deployment in AWS, we won't bother with this.
 * But if you're testing locally, you'll need these, or if you're connecting to
